...
while True:
    ...
    print(location)
    clist = js['results'][0]['address_components']
    countrycode = None
    try:
        for country in clist:
            if country['types'][0] == 'country':
                countrycode = country
        print('Country Code:', countrycode['short_name'])
    except:
        print('Sorry, this location does not have a country code or one could not be found')
